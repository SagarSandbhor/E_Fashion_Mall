...
selectcategory(id, name) {
  ...
  render(){
    return (
      ...
      <nav className="navbar navbar-expand-lg" style={{ backgroundColor: "#e40046"}}>
        <div className="container-fluid text-white">
          { window.localStorage.getItem("user_role") !== 'DELIVERY_BOY' &&
            ...
            <img src={logo} class="img-fluid" alt="Logo" width="70px" height="70px"/>
            </a>
          </a>
          }
        ...
        {this.state.st && window.localStorage.getItem("user_role") == 'DELIVERY_BOY' && 
          ...
          window.localStorage.getItem("user_role") !== 'SUPPLIER' &&
                      ...
                      <input className="form-control me-2"  size="60" type="text" placeholder="Search for products,brands & more..." aria-label="Search" name="searchProduct" value={this.state.searchProduct} onChange={this.onChange}/>
              <button className="btn btn-info" type="submit" onClick={this.searchProductByName}>Search</button>
            </form>
            </ul>
            }
              ...
              <Link to="/cart">
                <li class="nav-link">
                  <a href="#" class="cart position-relative d-inline-flex" aria-label="View your shopping cart">
                    <h5><i class="fas fa fa-shopping-cart fa-lg"  >Cart</i></h5>
            ...
            {!this.state.st && 
              <li className="nav-item">
                <Link to="/create-account">
                  <a className="nav-link"><h5 className="nameColor2">Sign Up</h5></a>
                </Link>
              </li>
            }
              {!this.state.st && 
