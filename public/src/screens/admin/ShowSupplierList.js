            ...
            <tbody>
                ...
                {this.state.suppliers.map(
                        ...
                        <tr key={supplier.id}>
                                ...
                                <td><Link to={"/supplier/showproductsbysupplier/"+supplier.id} className="btn btn-warning">Check Products</Link></td>
                                <td><Link to={"/addproductfromsupplier/"+supplier.id} className="btn btn-warning">Check Available Products</Link></td>
                                <td><Link to={"/supplieraddress/"+supplier.id} className="btn btn-warning">Address</Link></td>
                            </tr>
                    )
                }
            </tbody>  
            <br></br>
            <button className="btn btn-dark" onClick={() => this.addSupplier()}>Add Supplier</button>       
        </table>
    </div>
