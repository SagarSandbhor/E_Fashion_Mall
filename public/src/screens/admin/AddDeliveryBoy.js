      ...
      ApiCustomerService.addUser(user)
          .then(res => {
            if(res.data.result === null){
              toast.error("Email Addreess Already Registered")
            }
            if(res.data.result !== null){
              toast.success("DELIVERY_BOY Add successfully")
    ...
    return (
      ...
      <div className="row mb-3">
       ...
       <div className="row mb-3">
        ...
        <div className="mb-3">
          <button className="btn btn-dark float-center" onClick={this.registerUser}>
            Add Delivery Boy
          </button>
