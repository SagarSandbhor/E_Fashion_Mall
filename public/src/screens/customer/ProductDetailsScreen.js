            ...
            <div>
                <Navigation/>
                 <div className="container">
                    ...
                    <h4 className="nameColor">{this.state.product.productName}</h4>
                    <h5 className="nameColor7">₹. {this.state.product.finalPrice}</h5>

                    <h6 className="nameColor">₹. <strike>{this.state.product.price}</strike><span className="nameColor1">&nbsp; {this.state.product.discount}%Off</span></h6>
                    
                    <h6 className="nameColor"> Description :{this.state.product.description} </h6>
                    <h6 className="nameColor">Rating : {this.state.product.rating}</h6>
                    <button
                        onClick={() => {
