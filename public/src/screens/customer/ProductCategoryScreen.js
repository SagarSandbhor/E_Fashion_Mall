                    ...
                    {this.state.products.map(product => 
                        <div className="product col-md-3" key={product.id}>
                            <div className="title"> 
                                ...
                                <a className="nav-link" onClick={() => { this.productDetails(product) }}><h4 className="nameColor">{product.productName}</h4></a>
                                <h5 className="nameColor7" >₹. {product.finalPrice}</h5>
                                <h6 className="nameColor">₹. <strike>{product.price}</strike><span className="nameColor1">&nbsp; {product.discount}%Off</span></h6>                                
