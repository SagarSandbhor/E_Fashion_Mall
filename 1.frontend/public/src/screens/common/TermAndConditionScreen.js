...
const TermAndConditionScreen = () => {
    return (
        <div>
            ...
            <p>"CUSTOM FURNITURE" is the licensed owner of the brand customfurnitures.in 
                and the website Customfurniture.in (”The Site”)."CUSTOM FURNITURE"
                 respects your privacy. This Privacy Policy provides succinctly 
                 the manner your data is collected and used by "CUSTOM FURNITURE" on 
                 ...
                 use of your data by "CUSTOM FURNITURE" in the manner provided in this 
                 Privacy Policy.
            </p>
            <br/>
            <h5>Services overview
</h5>
            <p>As part of the registration process on the Site."CUSTOM FURNITURE" 
            ...
            <p>"CUSTOM FURNITURE" grants you a limited sub-license to access and make 
                ...
                written consent of "CUSTOM FURNITURE". This license does not include 
                ...
                express written consent of "CUSTOM FURNITURE". You may not frame or utilize 
                ...
                of "CUSTOM FURNITURE" and its affiliates without express written consent. 
                You may not use any meta tags or any other “hidden text” utilizing the 
                Site’s or "CUSTOM FURNITURE"’s name or MGM’s name or trademarks without the 
                express written consent of "CUSTOM FURNITURE". Any unauthorized use terminates 
                the permission or license granted by "CUSTOM FURNITURE"</p>
            <br/>
        </div>
        </div>
    );
